...
# ============================================================================
#
# Ce script package la Lambda engine avec les améliorations P1 :
# - Client Bedrock hybride (eu-west-3 newsletter, us-east-1 normalisation)
# - Cache S3 newsletter
# - Prompt ultra-réduit (-80% tokens)
#
# Usage: .\scripts\package-engine-p1.ps1
#
# ============================================================================
...
Write-Host "   Commande: aws lambda update-function-code --function-name vectora-inbox-engine-dev --zip-file fileb://$PACKAGE_NAME" -ForegroundColor Gray