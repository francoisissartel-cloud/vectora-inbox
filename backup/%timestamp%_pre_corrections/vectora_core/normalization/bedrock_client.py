...
class BedrockNormalizationClient:
    ...
    def normalize_item(self, item_text: str, canonical_examples: Dict, 
        ...
        Args:
            ...
            canonical_prompts: Prompts canonical avec anti-hallucinations
        
        Returns:
            Résultat de normalisation avec champs LAI
        """
        try:
            # Construction du prompt avec prompts canonical si disponibles
    ...
    def _build_normalization_prompt_v2(self, item_text: str, canonical_examples: Dict[str, str], 
        ...
        """
        Version améliorée utilisant les prompts canonical avec anti-hallucinations.
        
        Args:
            item_text: Texte à analyser
            canonical_examples: Exemples d'entités depuis les scopes
            canonical_prompts: Prompts canonical avec règles anti-hallucinations
        
        Returns:
            Prompt formaté pour Bedrock avec anti-hallucinations
        """
