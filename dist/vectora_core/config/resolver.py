...
def resolve_sources_for_client(
    ...
    6. Filtrer sur enabled=true et ingestion_mode valide
    ...
    Returns:
        ...
        - enabled: activation de la source
        - homepage_url, rss_url, html_url: URLs
    ...
    logger.info(f"Sources résolues avec métadonnées : {len(enabled_sources)}")
...
def load_matching_rules(config_bucket: str) -> Dict[str, Any]:
    ...
    Args:
        config_bucket: Nom du bucket S3 contenant les configs
