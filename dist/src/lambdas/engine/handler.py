...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        # P1: Paramètres newsletter cache (non utilisé pour l'instant)
        # force_regenerate = event.get("force_regenerate", False)  # P1: Bypass cache
        
        # Lecture des variables d'environnement (P1: ajout config hybride)
        env_vars = {
            ...
            # P1: Configuration hybride Bedrock
            ...
            "BEDROCK_REGION_NORMALIZATION": os.environ.get("BEDROCK_REGION_NORMALIZATION", "us-east-1"),
            "BEDROCK_MODEL_ID_NORMALIZATION": os.environ.get("BEDROCK_MODEL_ID_NORMALIZATION"),
        }
